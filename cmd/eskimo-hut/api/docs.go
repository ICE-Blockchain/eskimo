...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1w/kyc/checkFaceKYCStatus/users/{userId}": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/main.ForwardToFaceKYCRequestBody"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.ForwardToFaceKYCResponse"
                        }
                    },
                    "400": {
                        "description": "if user dont own remote profile",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "main.ForwardToFaceKYCRequestBody": {
            "type": "object",
            "properties": {
                "tokens": {
                    "type": "object",
